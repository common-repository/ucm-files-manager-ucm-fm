...
class GoogleStorageAdapter extends AbstractAdapter
{
    ...
    protected function upload($path, $contents, Config $config)
    {
        ...
        $options['name'] = $path;
        $options['predefinedAcl'] = $this->getPredefinedAclForVisibility('public');
    ...
    protected function getPredefinedAclForVisibility($visibility)
    {
        ...
        $acl = $ucm::ucmGetOption('fm_cloud_storage_upload_permission', 'private');
        if ($acl === 'public-read') {
            $acl = 'public';
        }

        return $visibility === $acl ? 'publicRead' : 'projectPrivate';
